...
game.import('mode',function(lib,game,ui,get,ai,_status){
	return {
		...
		start:function(){
			...
			if(!playback&&!_status.connectMode&&_status.mode=='deck'){
			...
			game.broadcast(function(side){
				game.me.side=side;
				game.me.enemy.side=!side;
			},game.enemy.side);
		...
		game:{
			...
			chooseCharacterOL:function(){
				...
				next.setContent(function(){
					...
					"step 3"
					game.me.chooseControl(lib.careerList);
					"step 4"
					get.deck(game.me,result.control||'random');
					game.enemy.chooseControl(lib.careerList);
					"step 5"
					get.deck(game.enemy,result.control||'random');
					setTimeout(function(){
